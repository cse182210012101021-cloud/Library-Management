...
import { chartData } from "@/shared/constant/default-values/ChartData";

export const description = "An interactive area chart";

// Dynamic config is created inside the component
...
export default function ChartArea({ chartData = [], userType }: { chartData?: any[], userType?: string }) {
  ...
  const effectiveConfig = userType === UserType.STUDENT ? {
    users: {
      label: "Pending",
      color: "var(--primary)",
    },
